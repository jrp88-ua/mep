<script lang="ts">
	...
	import { ExamineeForCreate, examineesStore } from '$lib/models/examinees';
	import { academicCentresStore } from '$lib/models/academicCentres';
	import { findAcademicCentreByName } from '$lib/services/academicCentres';
	import { createExaminee } from '$lib/services/examinees';

	const toast = getToastStore();
	let showAcademicCentreWarning = false;

	const allAcademicCentres = academicCentresStore.getAllInstances();
...
<div class="card p-4 variant-filled-seccondary" data-popup="academic-centre-warning">
